...
namespace rocketfellows\LUVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\LUVatNumberFormatValidatorsConfig\LUVatNumberFormatValidatorsConfig;

class LUVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = LUVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = LUVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::LU(), $config->getCountry());
    }
